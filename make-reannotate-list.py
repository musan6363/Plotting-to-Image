...
class MakeReannotateList:
    def __init__(self, dataset, version) -> None:
        ...
        self.checked_notuse_json = 'output/'+self.dataset_name+'/'+self.dataset_version+'/checked_ann_not_use.json'
        ...
        self.notuse_json = self.save_path+'/notuse.json'
    ...
    def make_notuse_list(self):
        self.notuse_list = []
        _not_use_targets = self.read_ndjson(self.checked_notuse_json)
        for d in _not_use_targets:
    ...
    def export(self):
        ...
        with open(self.notuse_json, 'w', encoding='utf-8') as f:
            json.dump(self.notuse_list, f, indent=2)
