...
class Application(tk.Frame):
    def __init__(self, master, ann_json: str, img_root: str, save_dir: str):
        ...
        self.master.geometry("2800x1100")
    ...
    def create_widgets(self):
        ...
        self.ann_canvas.create_text(1405, 50, text="STDEV: ", font=("Ricty", 20), anchor="nw", tag="stdev")
        # info frame
    ...
    def update_info_area(self):
        ...
        self.ann_canvas.create_text(1405, 50, text="STDEV: "+str(self.stdev), font=("Ricty", 20), anchor="nw", tag="stdev")
    ...
    def render_check_image(self, image_path: str, ped_bbox: list, ann_coords: list, ann_eyecontact: list, ann_difficult: list):
        ...
        fig = plt.figure(figsize=(im.size[0]/self.dim/100, im.size[1]/self.dim/100))
